export default {
  ...
  landingHome: {
    ...
    heroTitleLine1: 'Connect to AI.',
    heroTitleLine2: 'Let ideas grow freely.',
    heroIntroLine1: 'From the first line of code to the next finished piece.',
    heroIntroLine2: 'Bring model capabilities into your workflow through one API.',
    heroIntroLine3: 'Less setup. More creating.',
    start: 'Get started',
    viewExample: 'View an example',
    heroNote: 'API access / Coding assistants / Infinite Canvas',
    conceptLabel: 'Concept diagram connecting code, chat, images, and creative workflows through one API',
    modelsHint: 'Explore a multi-model ecosystem',
    modelsDisclaimer: 'Available models depend on your console configuration',
    possibilitiesTitle: 'One endpoint. More than one possibility.',
    possibilitiesDescription: 'Write code, build products, or turn the image in your head into a finished piece.',
    possibilitiesPrompt: 'Choose the way you want to begin.',
    developTitle: 'Connect your tools to more capability.',
    developDescription: 'Configure the API endpoint and key in compatible SDKs and developer tools without changing the workflow you know.',
    viewIntegration: 'View integration options ↗',
    exploreTitle: 'Keep the choice in your hands.',
    exploreDescription: 'Choose models for each task, manage keys, and review usage in the console. Availability, pricing, and access depend on your configuration.',
    exploreConsole: 'Explore the console ↗',
    createTitle: 'Ideas do not have to fit in one line.',
    createDescription: 'Bring images and ideas together in Infinite Canvas and give your creative work room to expand.',
    openCanvas: 'Open Infinite Canvas ↗',
    requestTitle: 'Start with one request.',
    requestDescription: 'There is no new workflow to learn.',
    requestPrompt: 'Use the familiar OpenAI SDK with your connection settings.',
    stepCreateKey: 'Log in and create an API key',
    stepSelectModel: 'Choose a model available to your group',
    stepSendRequest: 'Replace the example values and send your first request',
    exampleLanguage: 'Example language',
    copyCode: 'Copy code',
    codeDisclaimer: 'Integration example · Replace the API key and model · This page sends no requests',
    faqTitle: 'Before you begin.',
    faqToolsQuestion: 'Do I need to replace my existing developer tools?',
    faqToolsAnswer: 'Usually not. Compatible clients that support a custom Base URL can use this gateway. Confirm the supported endpoints for your tool and model before integrating.',
    faqPricingQuestion: 'Where can I see models and pricing?',
    faqPricingAnswer: 'Open the console to review groups, available models, and pricing. Current group configuration is authoritative.',
    faqCanvasQuestion: 'How do I use Infinite Canvas?',
    faqCanvasAnswer: 'After signing in, open the creative workspace and choose an API key with access to the required models. Image and other requests follow the selected group pricing rules.',
    finalTitle: 'Your next great piece starts here.',
    finalDescription: 'Keep the complexity behind the API and your attention on the idea.',
    createKey: 'Create your API key ↗',
    copied: 'Code copied. Replace the API key and model name.',
    selected: 'Code selected. Press Ctrl/Cmd + C to copy.',
  },
